...
const Note = (props) => {
  ...
  const supportedLanguageList = [
    {
      ...
      onAction: () => {
        ...
        updateText("javascript", index, "language");
      },
      color: "#084887",
    },
    {
      ...
      onAction: () => {
        setLanguage("python");
        updateText("python", index, "language");
      },
      color: "#36393B",
    },
    {
      ...
      onAction: () => {
        ...
        updateText("typescript", index, "language");
      },
      color: "#1E90FF ",
    },
    {
      ...
      onAction: () => {
        setLanguage("csharp");
        updateText("csharp", index, "language");
      },
      color: "#9932CC",
    },
    {
    ...
    },
    {
      ...
      onAction: () => {
        ...
        updateText("markdown", index, "language");
      },
      color: "#8A2BE2",
    },
    {
      ...
      onAction: () => {
        setLanguage("java");
        updateText("java", index, "language");
      },
      color: "#7FDBFF",
    },
    {
      ...
      onAction: () => {
        setLanguage("ruby");
        updateText("ruby", index, "language");
      },
      color: "#FA8072",
    },
    {
      ...
      onAction: () => {
        setLanguage("sass");
        updateText("sass", index, "language");
      },
      color: "#20B2AA",
    },
    {
  ...
  let noteMenuItems = [
    { child: "Edit", onAction: () => { handleEditNote() } },
    {
      ...
      onAction: () => {
        setWarningMessage(
          "Are you sure you want to delete the note? You cannot undo this action."
        );
      ...
      >
        ...
        >
          ...
          >
            {tags.length > 0 &&
              tags.map((tag, index) => {
                let obj = supportedLanguageList.find(
