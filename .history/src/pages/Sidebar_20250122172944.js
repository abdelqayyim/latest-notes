...
const Sidebar = (props) => {
    ...
    return (
        <nav id='sidebar' className={`${styles.sidebar} ${styles.close}`} ref={sidebar}>
            <CreateCourseForm open={showCreateCourseForm} onClose={()=>setShowCreateCourseForm(false)}/>
            <ul>
                <li>
                ...
                <li>
                    ...
                    <ul className={styles["sub-menu"]}>
                        <div>
                            <li><a href="#" onClick={(e) => { e.preventDefault();  setShowCreateCourseForm(true)}}>Course</a></li>
                            <li><a href="#">Note</a></li>
                        </div>
                    </ul>
                </li>
