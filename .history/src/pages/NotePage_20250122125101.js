...
const NotePage = (props) => {
    ...
    useEffect(() => {
        if (!languageName) { // If the value is not already loaded
            const fetchData = async () => {
                ...
                try {
                    const data = await LanguageServices.getNoteByLanguageName(paramLanguageName, noteId);
    ...
    return (
        <div style={{ display: "flex", flexDirection: "column", width: "100%", backgroundColor:"red" }}>
            <div style={{ width: "100%", height: "50px", fontSize: "32px" }}>
